                ...
                (<>
                    <div className="flex flex-col h-screen gap-20 justify-center">
                        ...
                        <div className="flex flex-col gap-8">
                            <input type="text" className="rounded-full py-2 px-12 text-green-800 max-w-[90%]" />
                            <input type="password" className="rounded-full py-2 px-12 text-green-800 max-w-[90%]" />
                            <input type="password" className="rounded-full py-2 px-12 text-green-800 max-w-[90%]" />
                        </div>
                    ...
                    <div className="flex flex-col gap-8">
                        <input type="text" className="rounded-full py-2 px-12 text-green-800 max-w-96" />
                        <input type="text" className="rounded-full py-2 px-12 text-green-800 max-w-96" /></div>
